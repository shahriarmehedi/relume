        ...
        <div className='max-w-7xl mx-auto px-5 2xl:px-0 mt-48'>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 lg:gap-10 mt-10">
                <div className='flex flex-col justify-center items-center  text-center'>
                    ...
                    <h3 className="font-bold mt-5 text-3xl">Acquiring and Trading NFTs in Shiba Shanti Inu</h3>
                ...
                <div className='flex flex-col justify-center items-center  text-center'>
                    ...
                    <h3 className="font-bold mt-5 text-3xl">Utilizing NFTs in the Game's Marketplace</h3>
                    <p className="mt-3 text-gray-300">
                ...
                <div className='flex flex-col justify-center items-center  text-center'>
                    ...
                    <h3 className="font-bold mt-5 text-3xl">Enhance Your Gameplay with NFTs</h3>
                    <p className="mt-3 text-gray-300">
