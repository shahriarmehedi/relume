        ...
        <div className='max-w-7xl mx-auto px-5 2xl:px-0 mt-48'>
            <div className='text-center'>
                ...
                <h2 className="text-5xl font-bold mt-5">
                    Unleash the Power of Our Roadmap
                </h2>
                <p className="mt-7 text-gray-300">
                    Our roadmap outlines the development milestones for our game, showcasing our commitment to delivering an exceptional gaming experience.
                </p>
