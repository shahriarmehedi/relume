        ...
        <div className='max-w-7xl mx-auto px-5 2xl:px-0 mt-48'>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 lg:gap-10 mt-10">
                <div className='flex flex-col justify-center items-center  text-center'>
                    ...
                    <h3 className="font-bold mt-5 text-3xl">Manage Resources and Survive in the Wasteland</h3>
                ...
                <div className='flex flex-col justify-center items-center  text-center'>
                    ...
                    <h3 className="font-bold mt-5 text-3xl">Expand Your Civilization and Conquer the Wasteland</h3>
                    <p className="mt-3 text-gray-300">
                ...
                <div className='flex flex-col justify-center items-center  text-center'>
                    ...
                    <h3 className="font-bold mt-5 text-3xl">Customize Your Weapons and Defend Against Enemies</h3>
                    <p className="mt-3 text-gray-300">
