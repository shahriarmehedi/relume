        ...
        <div className='max-w-7xl mx-auto px-5 2xl:px-0 mt-48'>
            <div className="flex items-center flex-col lg:flex-row gap-10">
                <div className='w-full lg:w-1/2'>
                    ...
                    <h2 className="text-3xl lg:text-5xl font-bold mt-5">Unlock the Power of <br /> In-Game NFT Assets</h2>
                    <p className="mt-7 text-gray-300">
                        Discover a new level of gaming with our in-game NFT assets. Buy and utilize these assets to enhance your gaming experience and stand out from the crowd.
                    </p>
                    ...
                    <div className="flex flex-col lg:flex-row gap-5 mt-10">
                        <div>
                            ...
                            <h3 className="font-bold mt-5">Unleash</h3>
                            <p className="mt-3 text-gray-300">
                                Unleash the potential of your gameplay with a wide range of unique NFT assets.
                            </p>
                        ...
                        <div>
                            ...
                            <h3 className="font-bold mt-5">Customize</h3>
                            <p className="mt-3 text-gray-300">
                                Customize your gaming experience with exclusive NFT assets that reflect your style and personality.
                            </p>
